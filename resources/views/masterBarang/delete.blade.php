...
<div class="modal fade" tabindex="-1" role="dialog" id="delete{{$item->encrypted_id}}">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">Apakah anda ingin menghapus data <span class="text-warning">{{$item->nama_barang}}</span> ?.<br> Data yang telah dihapus tidak dapat dikembalikan.</div>
            <div class="modal-footer"> 
                <form action="/master-barang/{{$item->encrypted_id}}/delete">
                    @csrf
                    @method('DELETE')
